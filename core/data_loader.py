...
class FileInfo:
    ...
    属性:
        ...
        fault_type: 故障类型 ('Normal', 'Ball', 'InnerRace', 'OuterRace_3', 'OuterRace_6', 'OuterRace_12')
...
class CWRUDataLoader:
    ...
    def _extract_fault_type(self, filename: str) -> str:
        ...
        支持的故障类型:
            - Ball: 滚动体故障
            - InnerRace: 内圈故障
            - OuterRace_3: 外圈故障 (3点钟位置)
            - OuterRace_6: 外圈故障 (6点钟位置)
            - OuterRace_12: 外圈故障 (12点钟位置)
        """
        if 'Ball' in filename:
            return 'Ball'
        elif 'InnerRace' in filename:
            return 'InnerRace'
        elif 'OuterRace12' in filename:
            return 'OuterRace_12'
        elif 'OuterRace6' in filename:
            return 'OuterRace_6'
        elif 'OuterRace3' in filename:
            return 'OuterRace_3'
        elif 'OuterRace' in filename:
            return 'OuterRace'  # 其他外圈故障
        return 'Unknown'
